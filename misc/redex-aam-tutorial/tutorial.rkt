...
(define-syntax-rule (-->vσ*+err/Σ alloc* ext-Σ lookup-Σ)
  (union-reduction-relations
...
(define-relation PCFσ^
  ...
  [(inv-⊑ σ σ_^)
   (inv-⊑ σ_1 σ_^′)
   ;(where #t (⊑σ σ_1 σ_^′)) error?
   (side-condition (term (⊑σ σ σ_^)))
...
(define-relation PCFσ^
  ...
  [(⊑Σ Σ_1 Σ_2)
   ...
   (side-condition (⊑Σ* (term Σ_1) (term Σ_2)))
   ]
  )
